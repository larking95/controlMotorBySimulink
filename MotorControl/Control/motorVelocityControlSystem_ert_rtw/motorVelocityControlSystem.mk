###########################################################################
## Makefile generated for Simulink model 'motorVelocityControlSystem'. 
## 
## Makefile     : motorVelocityControlSystem.mk
## Generated on : Fri Mar 20 20:46:43 2020
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/motorVelocityControlSystem.elf
...
PRODUCT_NAME              = motorVelocityControlSystem
MAKEFILE                  = motorVelocityControlSystem.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/Users/s-tsujii/OneDrive/Œ¤‹†ŽºŠÖŒW/MATLAB/Tests_etc/Arduino_control/MotorSystem/Control
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = motorVelocityControlSystem_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/motorVelocityControlSystem.elf
...
DEFINES_ = -DMODEL=motorVelocityControlSystem -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=1 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=motorVelocityControlSystem -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/motorVelocityControlSystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/motorVelocityControlSystem_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/motorVelocityControlSystem_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
